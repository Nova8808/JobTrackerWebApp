    ...
    public class FollowsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Follow != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Follow'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CompanyName,Info")] Follow follow)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CompanyName,Info")] Follow follow)
        {
            if (id != follow.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.Follow'  is null.");
            }
            var follow = await _context.Follow.FindAsync(id);
            if (follow != null)
            {
