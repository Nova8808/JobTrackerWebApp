...
namespace JobTrackerWebApp.Data
{
    public class JobsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Date,CompanyName,JobTitle,Location")] Job job)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Date,CompanyName,JobTitle,Location")] Job job)
        {
            if (id != job.Id)
            {
                return NotFound();
